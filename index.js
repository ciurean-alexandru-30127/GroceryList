...
// folosit pt a testa baza de date
...
//     db.users.push({id: 2, name: "Andrei"})
//     db.products.push({id: 2, name: "Red Peppers", stock: 100, measure: 'grams'})
//     saveDb()
...
app.get('/:page', function (req, res) {
    ...
    if (page.endsWith('.html') && !page.includes('/')) {
        ...
        res.sendFile(page, {root: __dirname + "/pages/"});
    } else {
        res.status(404).sendFile('404.html', {root: __dirname + "/pages/"});
    }
